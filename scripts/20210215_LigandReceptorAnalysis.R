...
# Unbiased full LR matrix -------------------------------------------------

# To view interactions between subtypes of microglia and subtypes of NSC,
# use: "results = subtype_results"
# Microglia subtypes are labeled as: MG.0, MG.1, MG.2 etc.
# NSC subtypes are labeled as: NSC.0, NSC.1, NSC.2 etc.
# 
# To view interactions between all microglia and all NSC, use: "results = celltype_results"
# Microglia labeled as : Microglia
# NSC labeled as: NSC
