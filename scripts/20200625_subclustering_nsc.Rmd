...
results_outpath <- '../results/20200625_subclustering_nsc/'
set.seed(123)
```
...
npcs <- which(nsc@reductions$pca@jackstraw$overall.p.values[,2] < 1e-5) # This was used for results sent to Suvra
# npcs <- 1:10
...
saveRDS(object = nsc, file = '../data/20200625_nsc.rds')
```
